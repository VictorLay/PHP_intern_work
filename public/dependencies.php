...
require_once "../app/courses/entities/Content.php";
require_once "../app/courses/entities/Course.php";
...
require_once "../app/core/utils/permission/impl/PermissionImpl.php";
require_once "../app/users/controllers/UserController.php";
require_once "../app/courses/controllers/CourseController.php";
require_once "../app/core/routers/Router.php";


require_once "../app/courses/views/html/DeleteHtml.php";
require_once "../app/courses/views/html/UpdateHtml.php";
require_once "../app/courses/views/html/ReadHtml.php";
require_once "../app/courses/views/html/CreateHtml.php";
require_once "../app/courses/views/HtmlCoursePageWriter.php";

require_once "../app/core/views/html/ErrorHtml.php";
require_once "../app/core/views/CoreHtmlPageWriter.php";
...
require_once "../app/users/views/HtmlUserPageWriter.php";
